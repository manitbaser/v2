...
const Navigation = React.forwardRef((props, ref) => {
  ...
  return (
    <Navbar
      ...
      expand="lg"
    >
      <Navbar.Brand className={`nav-link lead navbarbuttons`} style={{color: '#02aab0', border: '2px solid #11e2df'}} href={process.env.PUBLIC_URL + "/#home"}>
      {`<${mainBody.firstName} />`}
      </Navbar.Brand>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-md-auto">
          {about.show && (
            <Nav.Link
              className={`nav-link lead navbarbuttons`} style={{color: '#02aab0', border: '2px solid #11e2df'}}
