...
const Publication = ({ heading}) => {
  return (
    <Jumbotron fluid id="publications" className="bg-transparent text-light m-0">
    <Container className="">
    ...
    <Col md={6}>
      <Card className="card p-2">
        ...
        <center>
          <a href="https://ieeexplore.ieee.org/document/9342267" role="button" className="btn btn-outline-light">
    ...
    <Col md={6}>
      <Card className="card p-2">
        ...
        <center>
          <a href="https://ieeexplore.ieee.org/document/9342691" role="button" className="btn btn-outline-light">
        <i className="fas fa-rocket" /> Read More
      </a>
      </center>
      <br/>
